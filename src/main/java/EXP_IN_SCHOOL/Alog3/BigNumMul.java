...
public class BigNumMul {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String result=A + "\r\n\r\n"+" * " +"\r\n\r\n"+ B + "\r\n\r\n" + " = "
                    + "\r\n\r\n" + bigIntMultiply(new String(A), new String(B), Math.max(A.length(),
                    B.length()))+"\r\n\r\n";
            long end = System.currentTimeMillis();

            String timeres="\r\n\r\n"+"所用时间为：" + (end - start);
            OutputStream fileOutputStream = new FileOutputStream("E:\\Java\\MY_je_projects\\src" +
                    "\\main\\Alog3\\result.txt");
            fileOutputStream.write(result.getBytes(StandardCharsets.UTF_8));
            fileOutputStream.write(timeres.getBytes(StandardCharsets.UTF_8));
